...
Route::prefix($prefix)
    ...
    ->group(function () {
        ...
        Route::delete('/routes/deprecated', [RouteResourceController::class, 'cleanDeprecated'])->name('routes.clean_deprecated');
        Route::delete('/routes/{id}', [RouteResourceController::class, 'destroy'])->name('routes.destroy');
