        ...
        <form id="resetPasswordForm" method="POST" action="" style="padding: 20px;">
            ...
            <div style="margin-bottom: 14px;">
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <button type="button" class="btn btn-secondary btn-sm" id="btnToggleResetPwdEdit" onclick="togglePasswordVisibility('resetPasswordInput', this)" title="Mostra / Nascondi password">
                        👁️
                    </button>
            ...
            <div style="margin-bottom: 16px;">
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <button type="button" class="btn btn-secondary btn-sm" id="btnToggleResetConfirmPwdEdit" onclick="togglePasswordVisibility('resetPasswordConfirmInput', this)" title="Mostra / Nascondi password">
                        👁️
                    </button>
                </div>
            </div>
        ...
        <form id="activateForm" method="POST" action="" style="padding: 20px;">
            ...
            <div style="margin-bottom: 14px;">
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <button type="button" class="btn btn-secondary btn-sm" id="btnToggleActivatePwdEdit" onclick="togglePasswordVisibility('activatePasswordInput', this)" title="Mostra / Nascondi password">
                        👁️
                    </button>
            ...
            <div style="margin-bottom: 16px;">
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <button type="button" class="btn btn-secondary btn-sm" id="btnToggleActivateConfirmPwdEdit" onclick="togglePasswordVisibility('activatePasswordConfirmInput', this)" title="Mostra / Nascondi password">
                        👁️
                    </button>
                </div>
            </div>
